...
total_rooms = st.number_input("Total de cômodos", value=4)
total_bedrooms = st.number_input("Total de quartos", value=4)
population = st.number_input("População", value=4)
households = st.number_input("Domicílios", value=4)

median_income = st.slider("Renda média (multiplos de U$ 10K)", 0.15, 15.0, 4.5, 0.5)
